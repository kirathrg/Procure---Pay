...
export function MatchColumn({
  ...
  return (
    <div className="surface-panel flex-1 overflow-hidden rounded-lg border border-border bg-surface">
      ...
      <div className="relative divide-y divide-border">
        {fields.map((f) => (
          <div key={f.label} className="row-interactive px-4 py-3">
            <p className="text-[11px] text-text-faint">{f.label}</p>
            <p
              className={cn(
                "mt-0.5 font-tabular text-[13px] font-medium",
